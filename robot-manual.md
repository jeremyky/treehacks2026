中文版本：K1说明书-V1.3
This manual is for firmware V1.5 and above. For versions below V1.5, please visit theK1 Instruction Manual-V1.0
V1.5.1 Update Content
- Replace default gait with humanoid running gaits.
- Enable direct Agent switching without transitioning through Prepare Mode.
- Added new choreographies to Dance Agent: Mounts & Pals and Reform Breeze.
- Added Lion Dance 2 to Lion Dance Agent.
Product Overview
...
3. Default Agent（Booster）
  ...
  - Supports running function.
4. Soccer Agent
  - Supports track ball, chase ball and visual-based kicking, etc.
5. Teaching Agent
...
https://boosterobotics.s3.ap-southeast-1.amazonaws.com/ota_single/v1.5.1.11-release.global-0731-2026-02-11-22.04-aarch64-single.run
New Features: 
- Replaced default gait with human-like running gait 
- No need to enter prepare mode when switching between Agents 
- Dance Agent added Mounts & Pals Dance and Reform Breeze Dance 
- Lion Dance Agent added  Lion Dance 2
Bug Fixes: 
- Fixed Bluetooth network configuration issues 
- Fix issues related to OTA failures
-  Fixed "Lion Dance Prepare" icon non-display issue under Lion Dance Agent 
- Fixed occasional character icon non-display issue under Hi Chat Agent 
- Fixed AP direct connection failure issues 
-  Fixed odometer failure issue
- Fix excessive disk space usage by Soccer Agent logs
Upgrade K1 Software
...
This content is only supported in a Feishu Docs
This content is only supported in a Feishu Docs
Visual Detection Service Interface
This content is only supported in a Feishu Docs
This content is only supported in a Feishu Docs
This content is only supported in a Feishu Docs
Hardware Device Service Interface
Back Panel LED
This content is only supported in a Feishu Docs
